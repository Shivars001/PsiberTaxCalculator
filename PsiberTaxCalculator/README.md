...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="za.co.shivars.labournet.PsiberTaxCalculator.controller"/>` and `<mvc:annotation-driven/>` are used to register both the non-rest and rest controllers.
...
4. This will deploy `target/PsiberTaxCalculator.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/PsiberTaxCalculator/>.
